...
const WHY_US = [
  ...
  },
  {
    ...
    desc: "משרד בוטיק שמלווה חברות ציבוריות ופרטיות מזה למעלה מ־25 שנה. אנו מטפלים במידע של לקוחות תוך שמירה קפדנית על סודיות ושיקול דעת מקצועי, בכפוף לדין החל ולחובות המקצועיות.",
  },
  {
    icon: Rocket,
