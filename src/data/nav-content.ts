...
export const INDIVIDUALS_GROUPS_HE: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "גילוי מרצון ודיווח על נכסים והכנסות", to: "/tax-consulting" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "הכנסות משכר דירה בישראל", to: "/tax-consulting", hash: "rental-income" },
      { label: "הכנסות משכר דירה בחו״ל", to: "/tax-consulting", hash: "rental-income" },
...
export const INDIVIDUALS_GROUPS_EN: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Rental Income in Israel", to: "/en/tax-consulting", hash: "rental-income" },
      { label: "Foreign Rental Income", to: "/en/tax-consulting", hash: "rental-income" },
