...
export const TAX_TOPICS: Record<Lang, TaxTopic[]> = {
  he: [
    ...
    },
    {
      ...
      intro: "בחינת משיכות כספים, שכר, דיבידנדים, הלוואות והתחשבנויות בין החברה לבין בעלי המניות.",
      group: "A",
    },
    {
      ...
      intro: "בחינת מס שבח, מס רכישה, הכנסות משכר דירה והיבטי מס בעסקאות ובנכסים בישראל.",
      group: "A",
    },
    {
      ...
      intro: "בחינת תושבות מס, הכנסות מחו״ל, זיכוי מס זר, צדדים קשורים והחזקות בחברות זרות.",
      group: "A",
    },
    {
    ...
    },
    {
      ...
      intro: "הכנת מידע ודיווח שנתי ליחידים בהתאם להכנסות, לנכסים, למסמכים ולחובות הדיווח.",
      group: "B",
    },
    {
      ...
      label: "הצהרות הון",
      heading: "הצהרות הון",
      intro: "הכנת הצהרות הון, ריכוז נכסים והתחייבויות והתאמת המידע למסמכים ולדיווחים קודמים.",
      group: "B",
    },
    {
    ...
    },
    {
      ...
      intro:
        "בחינת זכאות אפשרית להחזר מס לשכירים נעשית על בסיס טופסי 106, אישורי ניכוי מס, נתוני הכנסות נוספות ואסמכתאות על זיכויים וניכויים אפשריים. במסגרת ההתקשרות ניתן לרכז את המידע, לבחון את שנות המס הפתוחות לדיווח ולהכין את הדוח השנתי בהתאם לנתונים שנמסרו ולהוראות הדין. קיום החזר בפועל, אם קיים, נקבע על ידי רשות המסים.",
      group: "B",
    },
    {
      ...
      intro:
        "לאפוטרופוסים ניתן לקבל סיוע בריכוז נתונים כספיים, בהכנת מידע לדיווחים תקופתיים ולדוחות הנדרשים ובבחינת חובות דיווח למס הכנסה בגין נכסים והכנסות של האדם שעליו מונתה האפוטרופסות. היקף השירות, אופן הדיווח והאחריות נקבעים בהתאם לנסיבות, למסמכים שנמסרו ולהוראות הגורמים המוסמכים.",
      group: "B",
    },
  ],
  en: [
