  ...
  head: () => ({
    meta: [
      { title: "הצהרת נגישות | נמרודי ושות׳ רואי חשבון" },
      {
        name: "description",
        content:
          "הצהרת הנגישות של נמרודי ושות׳ רואי חשבון: נגישות האתר, הסדרי ההגעה והנגישות הפיזית במשרד בהרצליה ודרכי פנייה לבקשת התאמה. קראו ופנו אלינו לבירור ראשוני.",
      },
          ...
          <div className="mx-auto max-w-3xl space-y-8 px-4 leading-relaxed text-muted-foreground sm:px-6">
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                הבניין, זמינותן אינה בשליטת המשרד ואינה מובטחת. קיים מסלול נגיש ורציף מהחניה ברחוב
                ועד למשרד, לרבות מעלית. בבניין קיימים שירותים, אך ככל הידוע למשרד הם טרם אושרו כנדרש
                וטרם סומנו כשירותים נגישים. אם נדרשת התאמת נגישות לצורך קבלת שירות, אנא צרו קשר מראש
                כדי שנוכל לבחון תיאום או חלופה נגישה בהתאם לצורך ולאפשרויות.
              </p>
            </div>
