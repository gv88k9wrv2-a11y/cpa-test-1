    ...
    items: [
      {
        ...
        a: "כן. יש לנו התמחות בייעוץ מס בינלאומי, דיווחי חשבונות בחו״ל (FBAR, CRS), מיסוי מטבעות דיגיטליים, ניתוק תושבות, ייעוץ לעולים חדשים ולתושבים חוזרים.",
      },
      {
        q: "מתי צריך לדווח על רווחים מקריפטו?",
        a: "רווח ממכירה או המרה של מטבע דיגיטלי חייב בדיווח ובמס רווח הון. אנו מסייעים בבניית תיעוד, חישוב מדויק של רווח/הפסד, וטיפול מלא מול רשות המסים – כולל הליכי גילוי מרצון בעת הצורך.",
      },
    ],
  },
];
