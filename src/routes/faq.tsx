...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "העלות תלויה בהיקף הפעילות, סוג הישות (חברה, עצמאי), מספר התנועות והשירותים הנדרשים. אנו שואפים לשקיפות ובהירות בתמחור ומציגים את היקף השירותים והעלות הצפויה מראש. פגישת ייעוץ ראשונית ללא התחייבות.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "כן. עבור פעילות מהותית או חדשנית (Trader מול Investor, סיווג הכנסת Staking, פעילות DeFi/NFT) אנו מסייעים בהכנת בקשות Pre-Ruling ובהצגת העמדה המקצועית לרשות המסים, ללא התחייבות לתוצאה מסוימת.",
      },
    ],
  },
];
