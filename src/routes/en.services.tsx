...
const GROUPS = [
    ...
    items: [
      {
        ...
        label: "Fractional CFO Services in Israel",
        icon: LineChart,
        desc: "Fractional CFO support for budgeting, cash flow, burn rate, runway, board reporting, financial models, and due diligence readiness.",
      },
      {
        to: "/en/bookkeeping",
        label: "Bookkeeping Services in Israel",
        icon: Calculator,
        desc: "Israeli bookkeeping services including monthly close, reconciliations, VAT reporting, and management information on digital platforms.",
      },
      {
        to: "/en/payroll",
        label: "Israeli Payroll and Section 102 ESOP",
        icon: ReceiptText,
        desc: "Israeli payroll services, payslips, Section 102 equity plans, Form 106, Form 161, employer reporting, and pension information.",
      },
      {
        to: "/en/audit",
        label: "Audit and Assurance Services in Israel",
        icon: FileSearch,
        desc: "Statutory financial statement audits under Israeli GAAP or IFRS, audit preparation, and financial due diligence support.",
      },
      {
        to: "/en/tax-consulting",
        label: "Israeli Tax Advisory",
        icon: FileSpreadsheet,
        desc: "Israeli tax planning, advance tax ruling requests, digital asset reporting, tax assessments, and objections.",
      },
    ],
  },

  {
    ...
    items: [
      {
        to: "/en/cpa-startups",
        label: "CPA Services for Startups and Technology Companies",
        icon: Building2,
        desc: "Startup accounting, fundraising readiness, Section 102 equity plans, Israel-Delaware flip analysis, and technology tax incentives.",
      },
      {
        to: "/en/cpa-freelancers",
        label: "CPA Services for Freelancers and Self-Employed Businesses",
        icon: Briefcase,
        desc: "Israeli tax registration, periodic filings, annual tax returns, capital declarations, rental income, and digital asset reporting.",
      },
      {
        to: "/en/cpa-foreign-companies",
        label: "CPA Services for Foreign Companies in Israel",
        icon: Globe2,
        desc: "Israeli subsidiary or branch analysis, bookkeeping, payroll, KYC information, transfer pricing, and local tax reporting.",
      },
      {
        to: "/en/cpa-herzliya",
        label: "CPA Firm in Herzliya Pituach",
        icon: MapPin,
        desc: "Boutique CPA firm in Herzliya Pituach serving companies, startups, foreign businesses, freelancers, and individuals.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: "Relocation, New Immigrants, and Returning Residents",
        icon: Plane,
        desc: "Israeli tax residency, relocation, new immigrant and returning resident benefits, tax treaties, and foreign income reporting.",
      },
    ],
  },
] as const;
  ...
  head: () => ({
    meta: [
      { title: "CPA Services in Israel | Nimrodi & Co., Herzliya Pituach" },
      {
        name: "description",
        content:
          "Accounting, tax and financial services in Israel for companies and startups: audit, payroll, bookkeeping, tax advisory and CFO support. Explore our services.",
      },
      { property: "og:title", content: "Accounting and Tax Services in Israel | Nimrodi & Co." },
      {
        property: "og:description",
        content:
          "Accounting, tax and financial services for companies and startups in Israel: audit, bookkeeping, payroll, tax advisory and CFO support. Explore our services.",
      },
      ...
      <main id="main-content">
        <section className="border-b border-border/60 bg-gradient-to-b from-secondary/60 to-background">
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
              Our Israeli CPA services may include bookkeeping, payroll, financial reporting, audit,
              tax advisory, fractional CFO support, and international tax matters, based on the
              agreed scope.
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-border/60 bg-primary py-16 text-primary-foreground">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="font-display text-3xl font-bold sm:text-4xl">
              Choose the Service Path That Fits Your Needs
            </h2>
            <p className="mt-3 text-primary-foreground/80">
              Start by client type or by the professional service required. Each path leads to the
        ...
        <GovPortalLinks
          ...
          links={[
            ...
            {
              label: "Israel Innovation Authority – Grants & Programs",
