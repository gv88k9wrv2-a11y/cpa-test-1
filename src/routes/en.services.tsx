...
export const Route = createFileRoute("/en/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Accounting, tax and financial services in Israel for companies and startups: audit, payroll, bookkeeping, tax advisory and CFO support. Explore our services." },
      { property: "og:title", content: "Accounting and Tax Services in Israel | Nimrodi & Co." },
      { property: "og:description", content: "Accounting, tax and financial services for companies and startups in Israel: audit, bookkeeping, payroll, tax advisory and CFO support. Explore our services." },
