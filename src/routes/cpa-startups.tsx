    ...
    <ServiceLanding
      ...
      sections={[
        ...
        },
        {
          ...
          body:
            "עסקת Secondary – מכירת מניות של מייסדים או עובדים למשקיע קיים או חדש – היא הזדמנות לנזילות מוקדמת, אך טעונה סיכוני מיסוי משמעותיים. סיווג שגוי עלול להשפיע מהותית על שיעור המס האפקטיבי. אנחנו מלווים את המייסדים והעובדים באסטרטגיה מלאה:",
          bullets: [
