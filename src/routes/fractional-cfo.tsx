    ...
    <ServiceLanding
      ...
      sections={[
        ...
        },
        {
          ...
          body:
            "משקיע רציני מחפש קודם כל מודל שמדבר את השפה שלו: הנחות ברורות, מנועי הכנסה מודולריים, וניתוחי רגישות המאפשרים לבחון תרחישים והנחות שונות. המודלים שלנו נבנים בהתאם לסטנדרטים המקובלים בקרנות הון סיכון ומיועדים לתמוך בתהליכי בדיקת נאותות (Due Diligence).:",
          bullets: [
        ...
        },
        {
          ...
          body:
            "הזדמנויות רכישה או גיוס מגיעות ללא התראה. חברה ערוכה יכולה להיכנס לתהליך משא ומתן בתוך זמן קצר; היעדר מוכנות עלול לעכב עסקאות ואף לפגוע בסיכויי השלמתן. אנחנו מנהלים את ה-Data Room כתהליך שוטף, לא כפרויקט חירום:",
          bullets: [
