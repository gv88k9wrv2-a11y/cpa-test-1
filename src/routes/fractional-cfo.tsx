...
const FAQS = [
  {
    ...
    a: "Fractional CFO הוא סמנכ״ל כספים בכיר במיקור חוץ, המצטרף לחברה בהיקף חלקי (יום בשבוע, כמה ימים בחודש) במקום עלות מלאה של CFO משרה מלאה. מתאים במיוחד לסטארטאפים בשלבי Seed–Series B, לחברות זרות שפועלות בישראל וזקוקות לדמות כספים בכירה מקומית, ולעסקים בצמיחה שעדיין לא מצדיקים CFO Full-Time. אתם מקבלים ניסיון בליווי חברות בתהליכי גיוס הון, דיווח כספי וסוגיות פיננסיות אסטרטגיות – במבנה גמיש המותאם לצורכי החברה.",
  },
  {
    q: "מה ההבדל בין Fractional CFO להנהלת חשבונות?",
    a: "הנהלת חשבונות היא רישום היסטורי של מה שקרה. Fractional CFO צופה קדימה: בונה מודל פיננסי, מנהל תזרים ו-Runway, מכין דקים למשקיעים, יושב עם הבורד, מנהל את ה-Data Room ומייצג בפני VC-ים. שני התפקידים משלימים, וניתן לקבל את שניהם במשרד בהתאם להיקף ההתקשרות המוסכם.",
  },
  {
  ...
  },
  {
    ...
    a: "מודל התמחור גמיש ותלוי היקף: Retainer חודשי קבוע (יום בשבוע / יומיים בחודש), פרויקטלי (הכנה לגיוס, הכנה ל-DD, בניית מודל פיננסי) או שילוב. יתרון עיקרי – אתם משלמים על השכבה הבכירה בלבד, כאשר הצוות המקצועי (הנהלת חשבונות, חשבות שכר, ביקורת) פועל תחתיו בעלות סטנדרטית. קבלו גישה לליווי פיננסי בכיר במבנה גמיש המותאם לצורכי החברה.",
  },
  {
