    ...
    <ServiceLanding
      ...
      sections={[
        ...
        },
        {
          ...
          body:
            "ישיבת דירקטוריון מקצועית ומוכנה היטב מחזקת את אמון המשקיעים והדירקטורים. אנחנו בונים את חבילת החומרים, מכינים את המייסדים ל-Q&A, ולעיתים יושבים בפגישה עצמה כדי לתמוך בהצגת הנתונים הכספיים ולחזק את האמינות הפיננסית:",
          bullets: [
            ...
            "עדכון חודשי למשקיעים, המחזק את האמון ואת המוניטין המקצועי",
