...
const FAQS = [
  ...
  },
  {
    ...
    a: "כן. אנחנו יושבים בפגישות VC ליד המייסדים, עונים על שאלות פיננסיות מורכבות, מסבירים את ההנחות שבמודל, ומלווים את החלק הכספי של המצגת. הליווי כולל הכנה מראש (Dry Run), Coaching על מונחים פיננסיים, ותגובה בזמן אמת לאתגרי המשקיעים סביב Unit Economics, LTV/CAC, Rule of 40 ו-Gross Margin.",
  },
  {
