      ...
      <main id="main-content" className="mx-auto max-w-3xl px-4 py-16 sm:px-6" dir="rtl">
        ...
        <article className="mt-10 space-y-10 text-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              המידע משמש אך ורק ליצירת קשר חוזר, מענה לפנייתכם ותיאום פגישת ייעוץ. המידע האישי אינו נמכר או מושכר לצדדים שלישיים. עם זאת, במקרים הנדרשים לצורך הפעלת האתר ומתן השירותים הנלווים, מידע עשוי להיות מעובד באמצעות ספקי שירות הפועלים מטעם המשרד, כגון ספקי אחסון, תשתיות מחשוב, אבטחה ושירותים טכנולוגיים, בכפוף להוראות הדין ולהסדרים המתאימים.
            </p>
          </section>
