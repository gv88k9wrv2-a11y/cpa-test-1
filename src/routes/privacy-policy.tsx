  ...
  head: () => ({
    meta: [
      { title: "מדיניות פרטיות ותנאי שימוש | נמרודי ושות׳ – רואי חשבון" },
      {
        name: "description",
        content:
          "מדיניות הפרטיות ותנאי השימוש של נמרודי ושות׳ רואי חשבון: איסוף מידע, שימוש, שמירה, אבטחה וזכויות משתמש בהתאם לדין החל. קראו את המדיניות המלאה באתר המשרד.",
      },
      ...
      { property: "og:title", content: "מדיניות פרטיות ותנאי שימוש | נמרודי ושות׳" },
      {
        ...
        content:
          "מדיניות הפרטיות של נמרודי ושות׳: איסוף מידע, שימוש, אבטחה וזכויות משתמש בהתאם לדין החל בישראל. קראו את המדיניות המלאה באתר.",
      },
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-4 py-16 sm:px-6" dir="rtl">
        ...
        <article className="mt-10 space-y-10 text-foreground leading-relaxed">
          <section>
            ...
            <p className="mt-3">
              נמרודי ושות׳ – רואי חשבון (להלן: "המשרד") מחויב לסודיות מקצועית וטיפול במידע בהתאם
              להוראות הדין ולמדיניות הפרטיות הרלוונטית של פרטי לקוחותיו והפונים אליו, בהתאם לכללי
              האתיקה המקצועית של רואי החשבון בישראל ולחוק הגנת הפרטיות, התשמ״א-1981 (לרבות תיקון מס'
              13).
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              אתר זה הינו אתר תדמיתי ואינפורמטיבי בלבד. האתר אינו כולל מערכת ייעודית להעלאת מסמכים
              או להעברת מסמכים פיננסיים או אישיים רגישים. אין להזין בטופס הפנייה או להעביר באמצעות
              האתר מידע פיננסי, אישי או סודי רגיש שאינו נדרש לצורך פנייה ראשונית.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              שם חברה, כתובת אימייל, מספר טלפון ותוכן ההודעה.{" "}
              <strong>לא חלה עליכם חובה חוקית</strong> למסור פרטים אלו.
            </p>
            <p className="mt-3">
              המידע משמש אך ורק ליצירת קשר חוזר, מענה לפנייתכם ותיאום פגישת ייעוץ. המידע האישי אינו
              נמכר או מושכר לצדדים שלישיים. עם זאת, במקרים הנדרשים לצורך הפעלת האתר ומתן השירותים
              הנלווים, מידע עשוי להיות מעובד באמצעות ספקי שירות הפועלים מטעם המשרד, כגון ספקי אחסון,
              תשתיות מחשוב, אבטחה ושירותים טכנולוגיים, בכפוף להוראות הדין ולהסדרים המתאימים.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              עיבוד הנתונים הטכניים עשוי להתבצע באמצעות ספקי שירותי מחשוב, תשתיות ואחסון בענן
              הכפופים להסכמי אבטחה וסודיות קפדניים. האתר מיועד לקהל עסקי ומקצועי ואינו אוסף ביודעין
              מידע מקטינים.
            </p>
            <p className="mt-3">
              ייתכן כי המידע יעובד או יאוחסן גם מחוץ לישראל באמצעות ספקי שירות העומדים בסטנדרטים
              מקובלים של אבטחת מידע וסודיות.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              המידע יישמר אך ורק לתקופה הנדרשת לטיפול בפנייתכם או בהתאם לחובות שמירת מסמכים על פי
              דין. עומדת לכם הזכות לעיין במידע האישי הנשמר אודותיכם בידי המשרד, לתקנו או לבקש את
              מחיקתו.
            </p>
            <p className="mt-3">
