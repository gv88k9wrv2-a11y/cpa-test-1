          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { to: "/en/tax-consulting", icon: Award, title: "Tax Advisory & Digital Assets", desc: "Israeli tax and reporting support for digital assets, including transaction-data organization, activity-classification review, source-of-funds documentation and tax-ruling requests.", badge: "Digital Asset Tax & Reporting" },
