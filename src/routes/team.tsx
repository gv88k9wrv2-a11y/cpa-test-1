...
const TEAM = [
  {
    ...
    role: "שותף מייסד",
    bio: "רואה חשבון מוסמך וחבר לשכת רואי החשבון. הרקע המקצועי כולל תפקידי חשב ומנהל כספים בחברות פרטיות וציבוריות, עבודה עם חברות זרות הפועלות בישראל, סוגיות במיסוי ישראלי ובין־לאומי והיבטים חשבונאיים ופיננסיים בתהליכי הנפקה וגיוס הון.",
  ...
  head: () => ({
    meta: [
      { title: "השותף המייסד | נמרודי ושות׳ – רואי חשבון בהרצליה" },
      {
        name: "description",
        content:
          "הכירו את צוות נמרודי ושות׳ בהרצליה פיתוח: רואי חשבון, מנהלי חשבונות ואנשי מקצוע בתחומי המס, השכר, הביקורת והדיווח. קראו עוד על צוות המשרד ותחומי העיסוק.",
      },
      ...
      <main id="main-content">
        ...
        <section className="border-t border-border/60 bg-primary py-14 text-primary-foreground">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="font-display text-2xl font-bold sm:text-3xl">רוצים לשוחח עם המשרד?</h2>
