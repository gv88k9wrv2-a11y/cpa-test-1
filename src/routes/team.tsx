...
const TEAM = [
  {
    ...
    role: "שותף מייסד",
    bio: "רואה חשבון מוסמך. חבר לשכת רואי החשבון. ניסיון עשיר כחשב וכמנהל כספים בחברות פרטיות וציבוריות. ניסיון רב שנים בייעוץ וליווי לחברות זרות שפועלות בישראל. בעל ניסיון במיסוי ישראלי ובין־לאומי, ובטיפול בסוגיות מס מורכבות עבור חברות ויחידים. ניסיון בליווי היבטים פיננסיים וחשבונאיים בתהליכי הנפקה בבורסה בישראל וסיוע פיננסי וחשבונאי לסטארטאפים בתהליכי גיוס הון.",
  ...
  head: () => ({
    meta: [
      { title: "השותף המייסד | נמרודי ושות׳ – רואי חשבון בהרצליה" },
      {
        name: "description",
        content:
          "הכירו את הצוות של נמרודי ושות׳ רואי חשבון בהרצליה פיתוח: צוות המשרד כולל רואי חשבון, מנהלי חשבונות ואנשי מקצוע בתחומי המס, השכר והדיווח, בהתאם לשירותים הניתנים ללקוחות המשרד. קראו עוד על הצוות שלנו.",
      },
