    ...
    <ServiceLanding
      ...
      sections={[
        ...
        },
        {
          ...
          body:
            "בעלי שליטה בחברות פרטיות חשופים למכשולים ייחודיים בפקודת מס הכנסה, ובעיקר לסעיפים 3(ט), 3(ט1) ו-3(ט2). משיכה לא נכונה יכולה להביא למיסוי של 48% ולקנסות. אנחנו בונים לבעלי שליטה תכנית משיכות חוקית ויעילה שממקסמת את התשואה נטו ומסייעת בהפחתת אי־ודאות בהתנהלות המס העתידית:",
          bullets: [
