...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "משרד רואי חשבון בוטיק בהרצליה פיתוח, המתמחה בליווי סטארטאפים וחברות זרות, שירותי CFO, מיסוי נכסים דיגיטליים והליכי גילוי מרצון." },
      { property: "og:description", content: "משרד רואי חשבון בוטיק בהרצליה פיתוח, המתמחה בליווי סטארטאפים וחברות זרות, שירותי CFO, מיסוי נכסים דיגיטליים והליכי גילוי מרצון." },
      { name: "twitter:description", content: "משרד רואי חשבון בוטיק בהרצליה פיתוח, המתמחה בליווי סטארטאפים וחברות זרות, שירותי CFO, מיסוי נכסים דיגיטליים והליכי גילוי מרצון." },
