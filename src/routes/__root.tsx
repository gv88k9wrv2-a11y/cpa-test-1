...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "רואי חשבון בהרצליה פיתוח: ליווי שוטף לחברות, סטארטאפים וחברות זרות בהנהלת חשבונות, שכר, דוחות כספיים, ביקורת וייעוץ מס בהיקף מוסכם. נשמח לשוחח על הצרכים שלכם." },
      { name: "twitter:description", content: "משרד רואי חשבון בוטיק בהרצליה פיתוח: הנהלת חשבונות, שכר, דוחות כספיים, ביקורת, ייעוץ מס ומיסוי נכסים דיגיטליים בהיקף מוסכם. נשמח לשמוע מכם ולסייע בהתאם לצורך." },
