  ...
  head: () => ({
    meta: [
      { title: "צור קשר | נמרודי ושות׳ – רואי חשבון בהרצליה פיתוח" },
      {
        name: "description",
        content:
          "צרו קשר עם נמרודי ושות׳ רואי חשבון בהרצליה פיתוח לשיחת היכרות בנושאי חשבונאות, מס, שכר, ביקורת וליווי פיננסי. טלפון, וואטסאפ ופרטי הגעה למשרד כאן. נשמח לסייע.",
      },
      { property: "og:title", content: "צור קשר – נמרודי ושות׳ רואי חשבון" },
      {
        property: "og:description",
        content:
          "פרטי התקשרות עם משרד רואי חשבון נמרודי ושות׳ בהרצליה פיתוח: טלפון, וואטסאפ, דוא״ל ופרטי הגעה, לצד טופס פנייה מקוון. נשמח לחזור אליכם בהקדם האפשרי. נשמח לסייע.",
      },
