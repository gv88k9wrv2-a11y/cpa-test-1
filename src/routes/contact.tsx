  ...
  head: () => ({
    meta: [
      { title: "צור קשר | נמרודי ושות׳ – רואי חשבון בהרצליה פיתוח" },
      {
        name: "description",
        content:
          "יצירת קשר עם נמרודי ושות׳ רואי חשבון בהרצליה פיתוח. טלפון 09-9582211, וואטסאפ 054-6688681. תאמו פגישת ייעוץ ראשונית ללא התחייבות.",
      },
    ...
    links: [
      { rel: "canonical", href: "https://cpa-test-1.lovable.app/contact" },
      { rel: "alternate", hrefLang: "he-IL", href: "https://cpa-test-1.lovable.app/contact" },
      { rel: "alternate", hrefLang: "en-US", href: "https://cpa-test-1.lovable.app/en/contact" }
    ],
  }),
