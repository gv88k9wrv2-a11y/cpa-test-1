    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/companies", en: "/en/companies", changefreq: "monthly", priority: "0.9" },
          { path: "/individuals", en: "/en/individuals", changefreq: "monthly", priority: "0.9" },
          ...
          { path: "/cpa-startups", en: "/en/cpa-startups", changefreq: "monthly", priority: "0.9" },
          {
            ...
            en: "/en/cpa-freelancers",
            changefreq: "monthly",
            priority: "0.9",
          },
          {
            path: "/cpa-international",
            en: "/en/cpa-international",
            changefreq: "monthly",
            priority: "0.9",
          },
          {
            path: "/cpa-foreign-companies",
            en: "/en/cpa-foreign-companies",
            changefreq: "monthly",
            priority: "0.9",
          },
          {
            path: "/tax-consulting",
            en: "/en/tax-consulting",
            changefreq: "monthly",
            priority: "0.9",
          },
          ...
          {
            path: "/blog/israeli-subsidiary-or-branch",
            en: "/en/blog/israeli-subsidiary-vs-branch",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/foreign-company-tax-liability-israel",
            en: "/en/blog/foreign-companies-operating-in-israel",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/relocation-tax-residency-israel",
            en: "/en/blog/relocation-tax-residency",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/rental-income-taxation-israel",
            en: "/en/blog/israeli-rental-income-tax-reporting",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/multiple-rental-properties-taxation",
            en: "/en/blog/multiple-rental-properties-business-classification-israel",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/crypto-reporting",
            en: "/en/blog/digital-assets-tax-reporting-israel",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/us-israel-tax-considerations",
            en: "/en/blog/israeli-tax-reporting-us-citizens",
            changefreq: "monthly",
            priority: "0.7",
          },
          {
            path: "/blog/startup-taxation-overview",
            en: "/en/blog/startup-accounting-tax-israel",
            changefreq: "monthly",
            priority: "0.7",
          },
