    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/en/blog/israeli-subsidiary-vs-branch", changefreq: "monthly", priority: "0.7" },
          { path: "/en/blog/foreign-companies-operating-in-israel", changefreq: "monthly", priority: "0.7" },
          { path: "/en/blog/relocation-tax-residency", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/rental-income-taxation-israel", changefreq: "monthly", priority: "0.7" },
          { path: "/blog/multiple-rental-properties-taxation", changefreq: "monthly", priority: "0.7" },
          ...
          { path: "/blog/startup-taxation-overview", changefreq: "monthly", priority: "0.7" },
