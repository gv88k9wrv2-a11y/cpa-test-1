...
const FAQS = [
  ...
  },
  {
    ...
    a: "הליווי כולל הנהלת חשבונות שוטפת, הפקת תלושי שכר, דוחות כספיים ודוחות שנתיים, ייעוץ מס, שירותי חשבות וניהול כספים, היערכות חשבונאית ופיננסית לתהליכי גיוס הון והנפקה – הכול תחת קורת גג אחת.",
  },
  {
  ...
  head: () => ({
    meta: [
      { title: "נמרודי ושות׳ – רואי חשבון בהרצליה לסטארטאפים וחברות זרות" },
      {
        name: "description",
        content:
          "משרד רואי חשבון בוטיק בהרצליה פיתוח, המתמחה בליווי סטארטאפים וחברות זרות, שירותי CFO, מיסוי נכסים דיגיטליים והליכי גילוי מרצון.",
      },
...
const SERVICES = [
  ...
  },
  {
    ...
    icon: Globe2,
    title: "ייעוץ מס בין־לאומי",
    desc: "התאמה למס בין־לאומי, דיווחי חו״ל, ניתוק תושבות, רילוקיישן ועולים חדשים.",
  },
  {
    to: "/tax-consulting",
    icon: FileSpreadsheet,
    title: "ייעוץ מס ודיווחים מיוחדים",
    desc: "התמחות מיוחדת במיסוי מטבעות דיגיטליים, ליווי עסקאות קריפטו מורכבות, עבודה מול בנקים ישראלים להכנסת כספי קריפטו, והכנת דיווחים לרשות המסים בהתאם לאופי הפעילות ולדרישות הדין. בנוסף: הכנסות משכירות, שוק ההון, גילוי מרצון וחוות דעת חשבונאיות.",
...
const HIGHLIGHTS = [
  { icon: Award, num: "משנת 2000", label: "שנת הקמת המשרד" },
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-20 sm:px-6 lg:py-28">
          <div className="max-w-2xl text-primary-foreground">
            ...
            <p className="mt-5 text-lg text-primary-foreground/85 sm:text-xl">
              נמרודי ושות׳ הוא משרד רואי חשבון בוטיק הפועל משנת 2000 ומלווה חברות,
              סטארטאפים, עצמאים ופעילות בין־לאומית בשירותי ביקורת, דיווח, מס וניהול כספים.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl">
              שירותי חשבונאות, מס וניהול כספים לחברות ולעצמאים
            </h2>
            <p className="mt-4 text-muted-foreground">
              משרד בוטיק המספק שירותי ביקורת, מס, הנהלת חשבונות וניהול כספים, בהתאם לצורכי הלקוח ולהיקף ההתקשרות.
            </p>
          </div>
