...
const FAQS = [
  ...
  },
  {
    ...
    a: "הליווי כולל הנהלת חשבונות שוטפת, הפקת תלושי שכר, דוחות כספיים ודוחות שנתיים, ייעוץ מס, שירותי חשבות וניהול כספים, ליווי גיוסי הון והכנה להנפקות – הכול תחת קורת גג אחת.",
  },
  {
  ...
  },
  {
    ...
    a: "כן. יש לנו התמחות מיוחדת במיסוי מטבעות דיגיטליים וב-Web3, ליווי עסקאות קריפטו מורכבות, ליווי ההתנהלות מול בנקים בישראל בכל הנוגע לכספים שמקורם בפעילות בנכסים דיגיטליים, והכנת דיווחים לרשות המסים בהתאם לאופי הפעילות ולדרישות הדין. בנוסף – ייעוץ מס בין־לאומי, דיווחי חשבונות בחו״ל (FBAR/CRS), ניתוק תושבות וייעוץ לעולים חדשים ותושבים חוזרים.",
  },
];
