...
const SERVICES = [
  {
    ...
    desc: "שירותי ראיית חשבון לסטארטאפים ולחברות טכנולוגיה: הנהלת חשבונות, שכר, דוחות כספיים, ביקורת, מיסוי ודיווח.",
  },
  {
    to: "/cpa-freelancers",
    icon: Briefcase,
  ...
  },
  {
    ...
    desc: "ניסיון בטיפול בסוגיות מס הנוגעות למטבעות דיגיטליים ונכסים דיגיטליים, לרבות בחינת אופי הפעילות, ארגון נתוני עסקאות והכנת מידע לדיווח ולבחינת מקור כספים, בהתאם לנתונים שנמסרו, לדרישות הגורמים הרלוונטיים ולהוראות הדין. בנוסף: הכנסות משכירות, שוק ההון, גילוי מרצון וחוות דעת חשבונאיות.",
