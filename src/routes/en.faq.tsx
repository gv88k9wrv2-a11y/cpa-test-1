...
const FAQS = [
  ...
  { cat: "Crypto & Web3", q: "Do you handle cryptocurrency and digital asset taxation?", a: "Yes — this is a core specialization. We provide end-to-end expertise in cryptocurrency and digital asset taxation, navigating complex Web3 transactions, facilitating the repatriation of crypto funds into Israeli banks, and filing tailored compliance reports with the Tax Authority." },
  { cat: "Crypto & Web3", q: "How do I move crypto proceeds into an Israeli bank account?", a: "We manage the full AML/KYC file end-to-end with Israeli banks — Source of Funds documentation, tax opinions, blockchain P&L reports and direct coordination with bank compliance departments, in strict alignment with Bank of Israel policy." },
  { cat: "Crypto & Web3", q: "When is a crypto transaction taxable in Israel?", a: "Every sale, coin-to-coin swap, DeFi action, staking reward, NFT mint/sale or purchase-in-crypto is a taxable event. We build a full transaction ledger across exchanges and wallets (Binance, Coinbase, Kraken, MetaMask), compute FIFO capital gains at the transaction-date FX, and file the correct return — plus Voluntary Disclosure where required." },
  { cat: "Crypto & Web3", q: "Can you obtain a Pre-Ruling for crypto activity?", a: "Yes. For material or novel activity — trader vs. investor classification, DeFi yield, staking income, NFT royalties — we prepare and negotiate Pre-Rulings with the Israel Tax Authority to lock in certainty before you file." },
];
