...
const FAQS = [
  ...
  { cat: "Crypto & Web3", q: "Can you assist with a tax-ruling request for digital-asset activity?", a: "Depending on the facts and the agreed scope, the firm may assist with the accounting and Israeli tax analysis, preparation of information for a tax-ruling request and coordination with legal or other advisers.
Filing a request does not guarantee that the Israel Tax Authority will issue a ruling or accept a particular position." },
];
