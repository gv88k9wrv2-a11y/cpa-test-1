...
const FAQS = [
  ...
  { cat: "Crypto & Web3", q: "Do you handle cryptocurrency and digital asset taxation?", a: "Yes — this is a core specialization. Transactions involving virtual currencies may give rise to tax and reporting obligations depending on the nature of the activity, the facts of the transactions, the taxpayer's circumstances, and applicable law. We provide end-to-end expertise in cryptocurrency and digital asset taxation, navigate complex Web3 transactions, and assist with preparing documentation and information regarding the source and history of funds for consideration by relevant financial institutions, subject to the bank's policies, compliance procedures, and final decision." },
