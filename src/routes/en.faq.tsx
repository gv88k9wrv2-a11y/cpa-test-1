...
const FAQS = [
  ...
  { cat: "Crypto & Web3", q: "Do you handle cryptocurrency and digital asset taxation?", a: "Yes. The firm assists with Israeli accounting, tax and reporting matters involving digital assets. The scope depends on the type of activity, the available transaction records, the taxpayer’s circumstances and the applicable reporting requirements. Where relevant, the work may include organizing transaction information and preparing accounting and tax information for review by financial institutions, subject to each institution’s policies and final decision." },
  { cat: "Crypto & Web3", q: "How do I move crypto proceeds into an Israeli bank account?", a: "Israeli financial institutions may request information about the source and history of digital-asset funds. Within the agreed scope, the firm may assist with organizing accounting and tax information for the institution’s review, subject to its policies, procedures and final decision." },
  { cat: "Crypto & Web3", q: "When is a crypto transaction taxable in Israel?", a: "Sales, coin-to-coin swaps, DeFi activity, staking rewards, NFT transactions and purchases made with digital assets may have Israeli tax and reporting implications, depending on the facts and applicable law. Within the agreed scope, the firm may assist with organizing transaction data, reviewing the activity and preparing information for Israeli tax reporting." },
  { cat: "Crypto & Web3", q: "Can you assist with a tax-ruling request for digital-asset activity?", a: "Depending on the facts and the agreed scope, the firm may assist with the accounting and Israeli tax analysis, preparation of information for a tax-ruling request and coordination with legal or other advisers. Filing a request does not guarantee that the Israel Tax Authority will issue a ruling or accept a particular position." },
];
