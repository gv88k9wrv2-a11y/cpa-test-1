...
import { Award, Building2, ChartLine, Handshake, MessageCircle, Star, Users } from "lucide-react";
...
const VALUES = [
  {
    icon: Award,
    title: "תהליכי עבודה ובקרות",
    desc: "כלים חשבונאיים ותהליכי עבודה הנבחרים בהתאם לסוג השירות ולהיקף ההתקשרות.",
  },
  {
    icon: Handshake,
    title: "קשר ישיר ודיסקרטיות",
    desc: "המשרד שואף לספק קשר ישיר ומענה אישי בהתאם לצורך ולהיקף ההתקשרות.",
  },
  {
    icon: ChartLine,
    title: "מידע חשבונאי וניהולי",
    desc: "הפקת מידע חשבונאי ופיננסי בהתאם לצורכי ההנהלה ולהיקף השירות.",
  },
  {
    icon: Users,
    title: "תקשורת ותיאום שוטף",
    desc: "ערוצי התקשורת, זמני המענה ואופן העבודה נקבעים בהתאם להיקף ההתקשרות.",
  },
];
        ...
        <section className="border-b border-border/60 bg-secondary/40">
          <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
              נמרודי ושות׳ הוא משרד רואי חשבון בוטיק הפועל משנת 2000 בהרצליה פיתוח ומספק שירותי
              חשבונאות, ביקורת, מס וניהול כספים לחברות, עצמאים ויחידים.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-5 lg:items-start">
            <div className="lg:col-span-3 space-y-5 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                פיננסיים של חברות ועסקים.
              </p>
              <p>
                המשרד מטפל גם בסוגיות הנוגעות לחברות טכנולוגיה וסטארטאפים, גיוסי הון, פעילות
                בין־לאומית, חברות זרות הפועלות בישראל, נכסים דיגיטליים וכן דיווח ומיסוי של הכנסות
                משכר דירה.
              </p>
              <p>
                העבודה מתבצעת בליווי אישי, בתיאום ציפיות מראש ובהתאם למידע, למסמכים ולתחומי האחריות
                שנקבעו בהתקשרות.
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              אפשר לקבוע פגישת היכרות במשרדנו בהרצליה פיתוח או בשיחת וידאו – ונראה איך נוכל לתמוך
              בכם.
            </p>
