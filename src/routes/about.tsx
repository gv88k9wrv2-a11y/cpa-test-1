      ...
      <section className="border-b border-border/60 bg-secondary/40">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
            המשרד פועל משנת 2000 ומספק שירותי חשבונאות, מס וניהול כספים לחברות, עצמאים
            ויחידים. השירות ניתן בהתאם לצורכי הלקוח ולהיקף ההתקשרות.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-5 lg:items-start">
          <div className="lg:col-span-3 space-y-5 text-muted-foreground leading-relaxed">
            <p>
              ...
              ומנוסה, הוקם ומנוהל על ידי רו״ח שלמה נמרודי – בעל ותק של למעלה מ־30 שנה
