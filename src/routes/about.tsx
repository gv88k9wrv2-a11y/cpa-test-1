...
const VALUES = [
  { icon: Award, title: "תהליכי עבודה ובקרה", desc: "כלים חשבונאיים ותהליכי עבודה הנבחרים בהתאם לסוג השירות ולהיקף ההתקשרות." },
  { icon: Handshake, title: "יחס אישי ודיסקרטי", desc: "המשרד שואף לספק קשר ישיר ומענה אישי בהתאם לצורך ולהיקף ההתקשרות." },
  { icon: ChartLine, title: "מידע לקבלת החלטות", desc: "הפקת מידע חשבונאי ופיננסי בהתאם לצורכי ההנהלה ולהיקף השירות." },
  { icon: Users, title: "תקשורת ותיאום עבודה", desc: "ערוצי התקשורת, זמני המענה ואופן העבודה נקבעים בהתאם להיקף ההתקשרות." },
];
