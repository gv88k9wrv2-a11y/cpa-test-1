...
const VALUES = [
  { icon: Award, title: "תהליכי עבודה ובקרות", desc: "כלים חשבונאיים ותהליכי עבודה הנבחרים בהתאם לסוג השירות ולהיקף ההתקשרות." },
  { icon: Handshake, title: "קשר ישיר ודיסקרטיות", desc: "המשרד שואף לספק קשר ישיר ומענה אישי בהתאם לצורך ולהיקף ההתקשרות." },
  { icon: ChartLine, title: "מידע חשבונאי וניהולי", desc: "הפקת מידע חשבונאי ופיננסי בהתאם לצורכי ההנהלה ולהיקף השירות." },
  { icon: Users, title: "תקשורת ותיאום שוטף", desc: "ערוצי התקשורת, זמני המענה ואופן העבודה נקבעים בהתאם להיקף ההתקשרות." },
];
